...
trait AuthenticationTable
{
    public function getInfoAuthentication($modules = '', $action = '', $active = 'Yes')
    {
        ...
        $wheres = array();
        $wheres['active'] = array('field' => 'active', 'operator' => '=', 'value' => $active);
        if (!empty($modules)) {
            $wheres['module'] = array('field' => 'module', 'operator' => '=', 'value' => $modules);
        }
        if (!empty($action)) {
            $wheres['action'] = array('field' => 'action', 'operator' => '=', 'value' => $action);
        }
    ...
    public function countAuthenticationMetaByUserGroup($id_group = null, $id_authentication = null)
    {
        $wheres = array();
        if (!empty($id_group)) {
            $wheres['id_group'] = array('field' => 'id_group', 'operator' => '=', 'value' => $id_group);
        }
        if (!empty($id_authentication)) {
            $wheres['id_authentication'] = array('field' => 'id_authentication', 'operator' => '=', 'value' => $id_authentication);
        }
    ...
    public function countAuthenticationMetaByUserID($user_id = null, $authentication_id = null)
    {
        $wheres = array();
        if (!empty($user_id)) {
            $wheres['user_id'] = array('field' => 'user_id', 'operator' => '=', 'value' => $user_id);
        }
        if (!empty($authentication_id)) {
            $wheres['authentication_id'] = array('field' => 'authentication_id', 'operator' => '=', 'value' => $authentication_id);
        }
    ...
    public function getInfoAuthenticationSidebar($sidebar_filename = '', $config_sidebar_sub = '', $active = 'Yes')
    {
        ...
        if (!empty($sidebar_filename)) {
            $wheres['sidebar_filename'] = array('field' => 'sidebar_filename', 'operator' => '=', 'value' => $sidebar_filename);
        }
        if (!empty($config_sidebar_sub)) {
            $wheres['config_sidebar_sub'] = array('field' => 'config_sidebar_sub', 'operator' => '=', 'value' => $config_sidebar_sub);
        }
    ...
    public function countAuthenticationSidebarMetaByUserGroup($id_group = null, $id_authentication = null)
    {
        ...
        if (!empty($id_authentication)) {
            $wheres['authentication_sidebar_id'] = array('field' => 'authentication_sidebar_id', 'operator' => '=', 'value' => $id_authentication);
        }
    ...
    public function countAuthenticationSidebarMetaByUserID($user_id = null, $authentication_id = null)
    {
        ...
        if (!empty($authentication_id)) {
            $wheres['authentication_sidebar_id'] = array('field' => 'authentication_sidebar_id', 'operator' => '=', 'value' => $authentication_id);
        }
